...
function XTopenQualifioForm() {
  ...
  const XTqualifioElement = '<section id="XTqualifioContainer"><picture><img src="https://i.imgur.com/0lcxkwp.jpg80"></picture><div id="qualifio_insert_place_932081" class="qualifio_iframe_wrapper"></div></section>';
...
function XTaddTheDropdownLink() {
  ...
  const XTanchorLinkToQualifio = '<a id="XTanchorLinkQualifio" href="#Above_XTqualifioContainer">Laat je reservatie aan huis leveren</a>';
...
_qual_async.push(['createIframe', 'qualifio_insert_place_932081', 'colruyt.qualifioapp.com', '20', '3245A9B4-5002-47AF-8828-F137DDF79969', '100%', '1200', '', '', '', 'max-width:810px;margin:0 auto;']);
